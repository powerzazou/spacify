    ...
    return (
      <button className='previousStepButton' onClick={() => this.props.changePage(this.props.path)}>
        ...
        <svg width='75px' height='9px' viewBox='0 0 75 9' version='1.1' xmlns='http://www.w3.org/2000/svg'>
          ...
          <defs />
          <g id='02.-Side' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd' transform='translate(-76.000000, -384.000000)'>
            <g id='Preview' transform='translate(80.000000, 361.000000)' stroke='#FFE818' strokeWidth='2'>
